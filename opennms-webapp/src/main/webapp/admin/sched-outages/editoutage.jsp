 ...
 *
 * Copyright (C) 2005-2021 The Renemon Group, Inc.
...
<%
	...
	for (org.opennms.netmgt.config.poller.Package thisPackage : PollerConfigFactory.getInstance().getExtendedConfiguration().getPackages()) {
