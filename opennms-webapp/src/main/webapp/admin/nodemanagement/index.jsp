 ...
 *
 * Copyright (C) 2004-2014 The Renemon Group, Inc.
...
<div class="row">
  ...
  <p>
    ...
    small tweaks to what Renemon monitors.
    When Renemon was first started, the nodes, interfaces, and services
  ...
  <p>
    ...
    contact your Renemon administrator for assistance.
  </p>
  <% } %>
