 ...
 *
 * Copyright (C) 2002-2016 The Renemon Group, Inc.
 * Renemon(R) is Copyright (C) 1999-2016 The Renemon Group, Inc.
 *
...
%>
  <h3 class="alert alert-success">Finished configuring SNMP. Renemon does not need to be restarted.</h3>
<%
}
%>
  ...
  <div class="col-md-6">
    <div class="card">
      ...
      <div class="card-body">
		...
		<p>Renemon will optimize this list, so enter the most generic
  ...
  <div class="col-md-6">
    <div class="card">
      ...
      <div class="card-body">
          ...
          <div class="form-group form-row">
            <label for="timeout" class="col-sm-3 col-form-label" data-toggle="tooltip" data-placement="right" title="The amount of time, in milliseconds, that Renemon will wait for a response from the agent.">
            Timeout
            </label>
            <div class="col-sm-9">
          ...
          <div class="form-group form-row">
            <label for="ttl" class="col-sm-3 col-form-label" data-toggle="tooltip" data-placement="right" title="The amount of time, in milliseconds, that Renemon will wait for a response from Minion.">
            TTL
            </label>
            <div class="col-sm-9">
  ...
  <div class="col-md-6 snmp-v1 snmp-v2c" style="display:none">
    <div class="card">
      ...
      <div class="card-body">
        ...
        <div class="form-group form-row">
          <label for="writeCommunityString" class="col-sm-4 col-form-label" data-toggle="tooltip" data-placement="right" title="The default 'write' community string for SNMP queries. Note that this is for future development - Renemon does not perform SNMP 'sets' at the moment.">
...
<div class="row">
  <div class="col-md-6">
    <div class="card">
      ...
      <div class="card-body">
        <div class="form-group form-row">
          <label for="sendEventOption" class="col-sm-3 col-form-label" data-toggle="tooltip" data-placement="right" title="By default the snmp configuration is published to the system by sending an event. This is useful if you have multiple Renemon instances running and want to notify all of them about the changes. If you do not which to send the event, unmark the checkbox. Be aware that collectd must be activated to process the event!">
          Send Event
          </label>
          <div class="col-sm-9">
