...
<div class="row">
  ...
  <div class="col-md-8">
    <div class="card">
      ...
      <div class="card-body">
        <p>
        Enter in a valid IP address to generate a newSuspectEvent. This will add a node to the Renemon
        database for this device. Note: if the IP address already exists in Renemon, use "Rescan" from
