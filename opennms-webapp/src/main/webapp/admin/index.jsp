    ...
    <div class="card">
      ...
      <div class="card-body">
        ...
        <p><b>Manage Provisioning Requisitions</b>: Add nodes, interfaces and services to
            Renemon based partly or completely on the contents of a Requisition rather than 
            strictly by having Renemon discover the network.
        </p>

        <p><b>Import and Export Asset Information</b>: Export and import data into Renemon's asset inventory.             
        ...
        <p><b>Configure Discovery</b>: Set up the IP addresses (individual addresses and/or ranges) that you want Renemon
        ...
        <p><b>Delete Nodes</b>: Permanently delete nodes from the database.
          ...
          <p><b>Secure Credentials Vault</b>: Encrypt credentials the Renemon system uses.
          </p>
        ...
        <p><b>Configure Notifications</b>: Create and manage notification escalation
            ...
            an Renemon event.  Each path can have any arbitrary number of escalations or 
            targets (users, groups, on-call roles) and can send notices through email, pagers, et cetera.  
            Each destination path can be triggered by any number of Renemon events and may 
        ...
        <p><b>Notification Status</b>: Notifications will be sent out only if this setting is switched to <em>On</em>.
            This is a system-wide setting. As long as this is <em>Off</em>, Renemon will not create notifications.
            The current status of notifications is reflected by the bell icon in the upper right-hand
            corner of every Renemon screen.
        </p>
        ...
        <P><B>Configure SNMP Community Names by IP Address</b>: Configure the Community String used in SNMP Data Collection and other SNMP operations. Renemon is shipped with a community string of "public".
        ...
        <p><b>Manage and Unmanage Interfaces and Services</b>: <em>Managing</em> an interface or service means that
            Renemon performs tests on this interface or service. If you want to explicitly enable or disable testing you
        ...
        the operation of perspective pollers that report back to this Renemon server to provide distributed
        status information.
        </p>

        <p><b>Manage Minions</b>: Configure and administer Renemon Minion servers that provide distributed 
        data collection for this Renemon server.
        </p>
