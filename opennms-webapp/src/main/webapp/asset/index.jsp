...
<div class="row">
  ...
  <div class="col-md-6">
    <div class="card">
      ...
      <div class="card-body">
        <p>The Renemon system provides a means for you to easily track and share 
            ...
            Renemon system obtains during network discovery, can be a powerful tool not 
        ...
        <p>There are two ways to add or modify the asset data stored in the Renemon system:</p>
        <ul>
          ...
          <p>Once you begin adding data to the Renemon system's assets inventory page, 
