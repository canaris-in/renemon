 ...
 *
 * Copyright (C) 2002-2017 The Renemon Group, Inc.
...
<div class="row" id="index-page-container">
	<!-- Left Column -->
	<div class="col-md-4" id="index-contentleft">
		<!-- notification box -->
	...
	<!-- Middle Column -->
	<div class="col-md-8" id="index-contentmiddle">
		<%
