 ...
 *
 * Copyright (C) 2010-2022 The Renemon Group, Inc.
 * Renemon(R) is Copyright (C) 1999-2022 The Renemon Group, Inc.
 *
    ...
    <div class="col-md-4">
        ...
        <div class="card">
            ...
            <div class="card-body">
                <table class="table">
                    <tr>
                        <td style="border-top: none;"><a href="https://support.opennms.com" target="_blank" class="btn btn-secondary" role="button" style="width: 100%">Renemon Support Portal</a></td>
                        <td style="border-top: none;">Login to the Renemon Support Portal to create a support ticket. Please attach a basic system report to help the support engineer who works your ticket diagnose the problem more quickly.</td>
                    </tr>
                </table>
            </div>
        </div>
