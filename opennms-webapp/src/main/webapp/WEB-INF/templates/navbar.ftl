...
<nav class="navbar navbar-expand-md navbar-dark opennms-bg-chromatic-black" id="header" role="navigation">
    ...
    <a class="navbar-brand" href="${baseHref}index.jsp">
        <img id="logo" src="${baseHref}images/renemon_title_image.svg" alt="Renemon logo" width="auto" height="auto" onerror="this.src='${baseHref}images/renemon_title_image.svg'" />
    </a>
    ...
    <div id="navbar" class="navbar-collapse collapse">
        ...
        <ul class="navbar-nav ml-auto">
  		  <#if request.remoteUser?has_content >
              ...
              <#if isAdmin >
                  <li class="nav-item">
                      <a class="nav-link" style="font-size: 1.25rem" title="Configure Renemon" href="${baseHref}admin/index.jsp"><i class="fa fa-cogs"></i></a>
                  </li>
              </#if>
          </#if>
        </ul>
